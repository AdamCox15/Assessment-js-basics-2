...
const pizza = {
    ...
    popularity: 8,
    rating: 8.5,
    tags: ['Pineapple', 'Ham', 'Sweet', 'Delicious','favorite', 'kids']
}
...
//const filteredFood = foodArr.filter(tags => tags.length === 'kids');

const filteredFood1 = foodArr.filter((food) => food.tags.includes('kids'));
