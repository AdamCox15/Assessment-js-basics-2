...
class Ticket{
  ...
  return `The order for customer ${customerId} is now ${this.status}.`
    }
}
...
class Ticket2 {
    constructor(items, orderTime, customerId){
        ...
        this.status = newStatus;
        console.log(`The status for ${this.customerId} is now ${this.status} `);
    }
}
...
//CODE HERE
const firstTicket = new Ticket2(['pizza', 'bread', 'soda'], '7:15', 322);
